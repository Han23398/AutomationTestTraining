...
public class Day13_BTVN {
	...
	@Test
	public void Testcase1_InCorrectUserAndPass() {
		SignInPage signInPage = new SignInPage(driver);
		signInPage.clickLogin("admin1@demo.com", "riseDemo1");
		signInPage.checkDisplayAlert();
	}
	
	@Test
	public void Testcase1_Logout() {
		SignInPage signInPage = new SignInPage(driver);
		signInPage.clickLogin("admin@demo.com", "riseDemo");
		WebElement avatar = driver.findElement(By.xpath("//a[@id=\"user-dropdown\"]"));
		avatar.click();
		WebElement signOut = driver.findElement(By.xpath("//a[@href=\"https://rise.fairsketch.com/signin/sign_out\"]"));
		signOut.click();
	}
	@BeforeTest
